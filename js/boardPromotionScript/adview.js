...
{		
	...
	this.click(function()
	{
		window.location.href="adwrite.jsp?id=" + id[1] + "&IU=update";
	});
};
	...
	this.click(function()
	{
		$.ajax(
		{
			...
			success:function(data)
			{
				...
				$.getLikeyCount(id[1], 'PR', r_id, btn, data.rValue);
			}
		});
	});
};
